...
const mockDirectSignals: Signal[] = [
  ...
  },
  {
    ...
    signalSubType: "financial",
    status: "review",
    title: "삼성전자 연체 플래그 활성화",
    summary: "삼성전자의 연체 플래그가 활성화되었습니다. R&D 투자 확대에 따른 일시적 유동성 악화로 추정되나, 상세 검토가 필요합니다.",
    source: "여신관리시스템",
    detectedAt: "3시간 전",
  ...
  },
  {
    ...
    signalSubType: "financial",
    status: "resolved",
    title: "휴림로봇 담보가치 15% 상승 확인",
    summary: "휴림로봇가 담보로 제공한 태양광 발전소 부지의 감정평가 결과, 담보가치가 15% 상승한 것으로 확인되었습니다.",
    source: "담보평가시스템",
    detectedAt: "어제",
