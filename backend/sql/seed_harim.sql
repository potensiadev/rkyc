...
VALUES (
    ...
    '{
        ...
        "total_exposure_krw": 120944754450,
        "yearly_trend": [
            {"year": 2024, "secured": 60, "unsecured": 36, "fx": 24, "total": 96},
            {"year": 2025, "secured": 66, "unsecured": 38, "fx": 27, "total": 108},
            {"year": 2026, "secured": 72, "unsecured": 30, "fx": 18, "total": 120}
        ],
        "composition": {
            "secured_loan": {"amount": 72566852670, "ratio": 60.0},
            "unsecured_loan": {"amount": 30236188612, "ratio": 25.0},
            "fx_loan": {"amount": 18141713167, "ratio": 15.0}
        },
        "risk_indicators": {
            "overdue_flag": false,
            "overdue_days": 0,
    ...
    '{
        ...
        "total_loan_against": 72566852670,
        "avg_ltv": 168.8,
    ...
    '{
        ...
        "years": {
            ...
            "2024": {
                "assets": 822242764735,
                "liabilities": 521549447397,
                "equity": 300693317338,
                "revenue": 1358340380389,
                "operating_income": 35356963177,
                "net_income": 10049710279,
                "debt_ratio": 173.45,
                "current_ratio": 128.0,
            ...
            "2025": {
                ...
                "equity": 275682682000,
                "revenue": 1233745815000,
                "operating_income": 22119201000,
                "net_income": -17965857000,
                "debt_ratio": 192.47,
                "current_ratio": 132.0,
    ...
    '[
        {
            ...
            "signal_type": "DIRECT",
            "title": "2025년 적자 전환",
            "description": "2025년 당기순손실 -179억원 기록. 전년 대비 매출 -9.2%, 영업이익 -37.4% 감소. 부채비율 192% 상승.",
            "recommended_action": "정기심사 시 수익성 개선 계획 및 현금흐름 점검 필요",
...
-- 검증
SELECT corp_id, corp_name, dart_corp_code, industry_code FROM corp WHERE corp_id = '4038-161113';
SELECT corp_id, data_date, (loan_exposure->>'total_exposure_krw')::bigint as total_exposure FROM rkyc_banking_data WHERE corp_id = '4038-161113';
